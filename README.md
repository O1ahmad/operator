...
| [<img src="https://cryptomode.com/wp-content/uploads/2020/08/CryptoMode-chainLink-Price-696x392.jpg"  width="150" height="100">](https://github.com/0x0I/operator/blob/master/ansible/O1labs/crypto/roles/chainlink/README.md) | an implementation of the Chainlink decentralized oracle network and smart-contract platform node |
...
| <img src="https://icodrops.com/wp-content/uploads/2018/05/Mina_logo-150x150.png" width="75" height="75"> [mina](https://github.com/0x0I/operator/blob/master/ansible/O1labs/crypto/roles/mina/README.md) | client node a part of Mina's succinct zero-knowledge protocol based on recursive composition of zk-SNARKs |
...
| [<img src="https://openethereum.github.io/images/logo-openethereum.svg"  width="100" height="100">](https://github.com/0x0I/operator/blob/master/ansible/O1labs/crypto/roles/openethereum/README.md) | a fast and feature-rich multi-network Ethereum client |
