...
| <img src="https://aqua-characteristic-rabbit-42.mypinata.cloud/ipfs/bafkreif3avobjtbmuqrodshyjfjnxskmcmixkltuzc3qeckzy4tjaz66ki"  width="50" height="50"> [chainlink](https://github.com/0x0I/operator/blob/master/ansible/O1labs/crypto/roles/chainlink/README.md) | an implementation of the Chainlink decentralized oracle network and smart-contract platform node |
| <img src="https://aqua-characteristic-rabbit-42.mypinata.cloud/ipfs/QmT7GyECG8zAjKWoT6ZgjBD7CZEhakCL6npeiFEf5m6b9M"  width="60" height="60"> [dogecoind](https://hub.docker.com/repository/docker/0labs/dogecoind) | Node software for the Dogecoin blockchain network |
| <img src="https://aqua-characteristic-rabbit-42.mypinata.cloud/ipfs/QmeKsV33Yi2hp4zRx1gZH4ZehPFHfkJjrHjxMsdnXap5uh"  width="75" height="75"> [erigon](https://hub.docker.com/repository/docker/0labs/erigon) | an implementation of Ethereum (execution client), on the efficiency frontier, written in Go |
...
| <img src="https://aqua-characteristic-rabbit-42.mypinata.cloud/ipfs/QmfGfAxdjwpkQiT9mG2yMYUnjpgrYp2aLDgtGZEEUDZBs3"  width="125" height="60"> [nimbus](https://hub.docker.com/repository/docker/0labs/nimbus/general) | a lightweight Ethereum consensus client developed by the Status Network |
