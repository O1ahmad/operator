...
| <img src="public/logos/erigon.png" width="75" height="75"> [erigon](https://hub.docker.com/repository/docker/0labs/erigon) | an implementation of Ethereum (execution client), on the efficiency frontier, written in Go |
